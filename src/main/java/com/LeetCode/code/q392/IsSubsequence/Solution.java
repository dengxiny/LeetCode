package com.LeetCode.code.q392.IsSubsequence;
/**
 * @QuestionId	:	392
 * @difficulty	:	Easy
 ...
 * @TranslatedContent:给定字符串 s 和 t ，判断 s 是否为 t 的子序列。
	...
	特别感谢 <a href="https://leetcode.com/pbrother/">@pbrother 添加此问题并且创建所有测试用例。
