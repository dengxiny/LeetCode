package com.LeetCode.code.q814.SmallestRotationwithHighestScore;
/**
 * @QuestionId	:	814
 * @difficulty	:	Hard
 ...
 * @TranslatedContent:给定一个数组 A，我们可以将它按一个非负整数 K 进行轮调，这样可以使数组变为 A[K], A[K+1], A{K+2], ... A[A.length - 1], A[0], A[1], ..., A[K-1] 的形式。此后，任何值小于或等于其索引的项都可以记作一分。
