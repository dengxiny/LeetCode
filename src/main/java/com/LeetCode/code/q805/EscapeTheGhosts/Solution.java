package com.LeetCode.code.q805.EscapeTheGhosts;
/**
 * @QuestionId	:	805
 * @difficulty	:	Medium
 ...
 * @TranslatedContent:你在进行一个简化版的吃豆人游戏。你从 (0, 0) 点开始出发，你的目的地是 (target[0], target[1]) 。地图上有一些阻碍者，第 i 个阻碍者从 (ghosts[i][0], ghosts[i][1]) 出发。
