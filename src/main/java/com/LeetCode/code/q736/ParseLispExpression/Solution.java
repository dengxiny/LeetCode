package com.LeetCode.code.q736.ParseLispExpression;
/**
 * @QuestionId	:	736
 * @difficulty	:	Hard
 ...
 * @TranslatedContent:给定一个类似 Lisp 语句的表达式 expression，求出其计算结果。
	...
	表达式语法如下所示:
		...
		add语法表示为 (add e1 e2)，其中 add 语法总是以字符串 "add"来表示，该语法总是有两个表达式e1<font color="#333333" face="Helvetica Neue, Helvetica, Arial, sans-serif"><span style="background-color:#ffffff; font-size:14px">、e2, 该语法的最终结果是 e1 表达式的值与 e2 表达式的值之和。
